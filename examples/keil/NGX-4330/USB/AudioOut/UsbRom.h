...
/** @defgroup Audio_Output_Device_ROM_Based ROM stack support
 * @ingroup LPC18xx_43xx_Audio_Output_Device
 * @{
 */

/** @defgroup Audio_OutputDevice_ROM_Based_Core ROM based core
 * @{
 */

/**
 * @brief	Call back function registers device descriptor array's address to ROM stack
 * @return	uint32_t value		: Address of device descriptor array
 */
 ...
 * @return	uint32_t value		: Address of device configuration descriptor array
 */
 ...
 * @return	uint32_t value		: Address of string descriptor array
 */
 ...
 * @return	uint32_t value		: Address of device qualifier descriptor array
 */
 ...
 * @return	uint8_t value		: Address of endpoint configuration descriptor array
 */
